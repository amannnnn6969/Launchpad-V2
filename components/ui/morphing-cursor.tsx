...
export function MagneticText({ text, hoverText = text, style, innerStyle, circleSize = 520 }: MagneticTextProps) {
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          transition: "width 0.55s cubic-bezier(0.33,1,0.68,1), height 0.55s cubic-bezier(0.33,1,0.68,1)",
      ...
      >
        ...
        >
          <span style={{ ...innerStyle, color: "#fff", whiteSpace: "nowrap" }}>{hoverText}</span>
        </div>
      </div>
    </div>
  )
