...
export default function WhoWeHelp() {
  ...
  return (
    <section id="who" style={{ padding: "7rem 3rem", maxWidth: 1200, margin: "0 auto" }}>
      <p
        ref={ref}
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3.5rem", alignItems: "center", marginTop: "3rem" }}>
        <RevealBlock delay={0}>
          <h2 style={{ fontFamily: "Syne, sans-serif", fontSize: "clamp(1.9rem, 3.5vw, 3rem)", fontWeight: 800, lineHeight: 1.12, letterSpacing: "-0.03em", marginBottom: "1.2rem", color: "var(--text)" }}>
        ...
        <RevealBlock delay={100}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.2rem" }}>
            {stats.map((s) => (
              ...
              >
                <div style={{ fontFamily: "Syne, sans-serif", fontSize: "2.4rem", fontWeight: 800, color: "var(--accent)" }}>{s.num}</div>
                <div style={{ fontSize: "0.81rem", color: "var(--muted)", marginTop: "0.3rem" }}>{s.desc}</div>
              </div>
            ))}
          </div>
        </RevealBlock>
